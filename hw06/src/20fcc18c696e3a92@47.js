...
__query(FileAttachment("artistVer (1) - artistVer (1) (1).csv"),{from:{table:"artistVer (1) - artistVer (1) (1)"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation)
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["artistVer (1) - artistVer (1) (1).csv", {url: new URL("artistVer (1) - artistVer (1) (1).csv", import.meta.url), mimeType: "text/csv", toString}],
