...
function _simple1(d3,data,drag,invalidation)
{
   // 指定圖表的尺寸。
  const width = 1500;
  const height = 1000;
...
function _simple2(d3,data,drag,invalidation)
{
   // 指定圖表的尺寸。
  const width = 1500;
  const height = 1000;
...
function _simple3(d3,data,drag,invalidation)
{
   // 指定圖表的尺寸。
  const width = 1500;
  const height = 1000;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("simple1")).define("simple1", ["d3","data","drag","invalidation"], _simple1);
  main.variable(observer()).define(["md"], _4);
  main.variable(observer("simple2")).define("simple2", ["d3","data","drag","invalidation"], _simple2);
  main.variable(observer()).define(["md"], _6);
  main.variable(observer("simple3")).define("simple3", ["d3","data","drag","invalidation"], _simple3);
